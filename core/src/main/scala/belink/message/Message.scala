...
import com.ynet.belink.common.record.{CompressionType, LegacyRecord, TimestampType}
import com.ynet.belink.common.utils.{ByteUtils, Crc32}
...
class Message(val buffer: ByteBuffer,
  ...
  import belink.message.Message._
