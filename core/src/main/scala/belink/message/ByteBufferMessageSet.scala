...
import com.ynet.belink.common.record.{AbstractLegacyRecordBatch, CompressionType, MemoryRecords, TimestampType}
...
class ByteBufferMessageSet(val buffer: ByteBuffer) extends MessageSet with Logging {
  ...
  private[belink] def this(compressionCodec: CompressionCodec,
