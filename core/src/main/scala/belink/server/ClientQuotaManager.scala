...
import belink.utils.{ShutdownableThread, Logging}
import com.ynet.belink.common.MetricName
import com.ynet.belink.common.metrics._
import com.ynet.belink.common.metrics.stats.{Total, Rate, Avg}
...
class ClientQuotaManager(private val config: ClientQuotaManagerConfig,
   ...
   */
  protected def throttleTime(clientMetric: BelinkMetric, config: MetricConfig): Long = {
