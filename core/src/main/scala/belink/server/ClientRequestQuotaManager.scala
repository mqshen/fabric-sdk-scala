...
import com.ynet.belink.common.metrics.{BelinkMetric, MetricConfig, Metrics}
...
class ClientRequestQuotaManager(private val config: ClientQuotaManagerConfig,
  ...
  override protected def throttleTime(clientMetric: BelinkMetric, config: MetricConfig): Long = {
