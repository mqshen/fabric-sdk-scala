...
import belink.common.NotificationHandler
import belink.utils.{Json, Logging}
 ...
 *
 */
class DynamicConfigManager(private val configHandlers: Map[String, ConfigHandler],
  ...
  object ConfigChangedNotificationHandler extends NotificationHandler {
    ...
    private def processEntityConfigChangeVersion1(json: String, map: Map[String, Any]) {
      ...
      //val entityConfig = AdminUtils.fetchEntityConfig(entityType, entity)
    ...
    private def processEntityConfigChangeVersion2(json: String, map: Map[String, Any]) {
      ...
      //val entityConfig = AdminUtils.fetchEntityConfig(rootEntityType, fullSanitizedEntityName)
