...
import belink.common.LongRef
import belink.message.{CompressionCodec, NoCompressionCodec}
import belink.utils.Logging
import com.ynet.belink.common.errors.{InvalidTimestampException, UnsupportedForMessageFormatException}
import com.ynet.belink.common.record._

import scala.collection.JavaConverters._
import scala.collection.mutable

private[belink] object LogValidator extends Logging {
   ...
   */
  private[belink] def validateMessagesAndAssignOffsets(records: MemoryRecords,
