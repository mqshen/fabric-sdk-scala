...
public abstract class AbstractCoordinator implements Closeable {
    ...
    private class JoinGroupResponseHandler extends CoordinatorResponseHandler<JoinGroupResponse, ByteBuffer> {
        ...
        public void handle(JoinGroupResponse joinResponse, RequestFuture<ByteBuffer> future) {
            ...
            if (error == Errors.NONE) {
                ...
                future.raise(new BelinkException("Unexpected error in join group response: " + error.message()));
            }
        }
    }
        ...
        public void handle(SyncGroupResponse syncResponse,
            ...
            if (error == Errors.NONE) {
                ...
                if (error == Errors.GROUP_AUTHORIZATION_FAILED) {
                    ...
                    future.raise(new BelinkException("Unexpected error from SyncGroup: " + error.message()));
                }
            }
        }
    }
    ...
    private class HeartbeatResponseHandler extends CoordinatorResponseHandler<HeartbeatResponse, Void> {
        ...
        public void handle(HeartbeatResponse heartbeatResponse, RequestFuture<Void> future) {
            ...
            if (error == Errors.NONE) {
                ...
                future.raise(new BelinkException("Unexpected error in heartbeat response: " + error.message()));
            }
        }
    }
    ...
    private class HeartbeatThread extends BelinkThread {
