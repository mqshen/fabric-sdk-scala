 ...
 */
package com.ynet.belink.common.security.ssl;

import com.ynet.belink.common.Configurable;
import com.ynet.belink.common.BelinkException;
import com.ynet.belink.common.config.SslConfigs;
import com.ynet.belink.common.config.types.Password;
import com.ynet.belink.common.network.Mode;
...
public class SslFactory implements Configurable {
    ...
    private void createKeystore(String type, String path, Password password, Password keyPassword) {
        if (path == null && password != null) {
            throw new BelinkException("SSL key store is not specified, but key store password is specified.");
        } else if (path != null && password == null) {
            throw new BelinkException("SSL key store is specified, but key store password is not specified.");
        } else if (path != null && password != null) {
    ...
    private void createTruststore(String type, String path, Password password) {
        if (path == null && password != null) {
            throw new BelinkException("SSL trust store is not specified, but trust store password is specified.");
        } else if (path != null) {
