...
public class Utils {
    ...
    public static <T> T newInstance(Class<T> c) {
        try {
            ...
            throw new BelinkException("Could not instantiate class " + c.getName(), e);
        } catch (InstantiationException e) {
            throw new BelinkException("Could not instantiate class " + c.getName() + " Does it have a public no-argument constructor?", e);
        } catch (NullPointerException e) {
            throw new BelinkException("Requested class was null", e);
        }
    }
    ...
    public static <T> T newInstance(String klass, Class<T> base) throws ClassNotFoundException {
        return Utils.newInstance(Class.forName(klass, true, Utils.getContextOrBelinkClassLoader()).asSubclass(base));
    }
    ...
    */
    public static ClassLoader getBelinkClassLoader() {
     ...
     */
    public static ClassLoader getContextOrBelinkClassLoader() {
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        if (cl == null)
            return getBelinkClassLoader();
        else
            return cl;
    }
