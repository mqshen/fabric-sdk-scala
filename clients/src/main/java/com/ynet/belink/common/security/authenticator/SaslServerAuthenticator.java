...
import com.ynet.belink.common.protocol.Protocol;
...
import com.ynet.belink.common.security.kerberos.KerberosName;
import com.ynet.belink.common.security.kerberos.KerberosShortNamer;
import com.ynet.belink.common.security.scram.ScramCredential;
import com.ynet.belink.common.security.scram.ScramMechanism;
import com.ynet.belink.common.security.scram.ScramServerCallbackHandler;
...
public class SaslServerAuthenticator implements Authenticator {
    ...
    private SaslServer createSaslKerberosServer(final AuthCallbackHandler saslServerCallbackHandler, final Map<String, ?> configs) throws IOException {
        ...
        try {
            ...
            throw new BelinkException("Principal has name with unexpected format " + servicePrincipal);
        }
    ...
    public Principal principal() {
        return new BelinkPrincipal(BelinkPrincipal.USER_TYPE, saslServer.getAuthorizationID());
    }
