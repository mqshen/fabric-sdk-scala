...
import com.ynet.belink.common.record.FileLogInputStream.FileChannelRecordBatch;
...
public class FileRecords extends AbstractRecords implements Closeable {
    ...
    public int truncateTo(int targetSize) throws IOException {
        ...
        if (targetSize > originalSize || targetSize < 0)
            throw new BelinkException("Attempt to truncate log segment to " + targetSize + " bytes failed, " +
    ...
    public long writeTo(GatheringByteChannel destChannel, long offset, int length) throws IOException {
        ...
        if (newSize < oldSize)
            throw new BelinkException(String.format(
