...
public final class Sensor {
    ...
    private final List<BelinkMetric> metrics;
    ...
    public void checkQuotas(long timeMs) {
        for (BelinkMetric metric : this.metrics) {
    ...
    public synchronized void add(MetricName metricName, MeasurableStat stat, MetricConfig config) {
        BelinkMetric metric = new BelinkMetric(new Object(),
    ...
    synchronized List<BelinkMetric> metrics() {
