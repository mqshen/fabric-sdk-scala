...
import com.ynet.belink.common.utils.ByteBufferOutputStream;
import com.ynet.belink.common.utils.ByteUtils;
import com.ynet.belink.common.utils.CloseableIterator;
import com.ynet.belink.common.utils.Crc32C;
        ...
        return new RecordIterator() {
            ...
            protected Record readNext(long baseOffset, long firstTimestamp, int baseSequence, Long logAppendTime) {
                try {
                    ...
                    throw new BelinkException("Failed to decompress record stream", e);
                }
            }
            ...
            protected boolean ensureNoneRemaining() {
                try {
                    ...
                    throw new BelinkException("Error checking for remaining bytes after reading batch", e);
                }
            }
            ...
            public void close() {
                try {
                    ...
                    throw new BelinkException("Failed to close record stream", e);
                }
            }
        };
    }
