 ...
 */
package com.ynet.belink.common.config;
...
public class AbstractConfig {
    ...
    public <T> T getConfiguredInstance(String key, Class<T> t) {
        ...
        if (!t.isInstance(o))
            throw new BelinkException(c.getName() + " is not an instance of " + t.getName());
        ...
        for (Object klass : klasses) {
            ...
            if (klass instanceof String) {
                try {
                    ...
                    throw new BelinkException(klass + " ClassNotFoundException exception occurred", e);
                }
            } else if (klass instanceof Class<?>) {
                o = Utils.newInstance((Class<?>) klass);
            } else
                throw new BelinkException("List contains element of type " + klass.getClass().getName() + ", expected String or Class");
            if (!t.isInstance(o))
                throw new BelinkException(klass + " is not an instance of " + t.getName());
            if (o instanceof Configurable)
