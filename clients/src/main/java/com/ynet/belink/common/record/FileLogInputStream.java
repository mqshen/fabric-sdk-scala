...
import static com.ynet.belink.common.record.Records.LOG_OVERHEAD;
    ...
    public static class FileChannelRecordBatch extends AbstractRecordBatch {
        ...
        public long lastOffset() {
            ...
            try {
                ...
                if (buf.hasRemaining())
                    throw new BelinkException("Failed to read magic byte from FileChannel " + channel);
        ...
        private void loadUnderlyingRecordBatch() {
            try {
                ...
                throw new BelinkException("Failed to load record batch at position " + position + " from file channel " + channel);
            }
        }
        ...
        public void writeTo(ByteBuffer buffer) {
            try {
                ...
                throw new BelinkException("Failed to read record batch at position " + position + " from file channel " +
                        channel, e);
            }
        }
