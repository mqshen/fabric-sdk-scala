 ...
 */
package com.ynet.belink.common.security;
...
public class JaasUtils {
    ...
    public static boolean isZkSecurityEnabled() {
        ...
        try {
            ...
            throw new BelinkException("Exception while loading Zookeeper JAAS login context '" + zkLoginContextName + "'", e);
        }
        if (isSecurityEnabled && !zkSaslEnabled) {
            ...
            throw new BelinkException("Exception while determining if ZooKeeper is secure");
        }
